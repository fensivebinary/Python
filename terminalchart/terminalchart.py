'''
make a chart on terminal:
take input from user like x = {1,2,3,4,5,6,7,8,9} and y = {4,5,9,8,7,6,3,4,7}
and output:
  -       
    -    
    -   -
...
if __name__ == '__main__':
	...
	parser.add_argument("-o", "--output", required=True, help="where you want your output to be, -o t for teminal, -o output_file for file")
